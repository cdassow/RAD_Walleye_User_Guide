...
The 'Walleye Stocking' tab will only be of use if the user-selected lake has been stock or if the user is considering stocking and wants to see what the stocking histories are for similar lakes.
...
##### Data Note
The stocking data in the app will be periodically updated. As of initial deployment to the R shiny server the stocking data covers only walleye stocking events from 1971 to 2021.
